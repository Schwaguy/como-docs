...
foreach ($comodoc_array as $doc) {
	...
	// Date Column
	$comodocDisplay .='<div class="col-12 col-xs-12 col-sm-4 col-md-3 col-lg-3 col-xl-2">';
	$comodocDisplay .= '<span class="date" itemprop="datePublished">'. date('F, Y', strtotime($doc['pub-date'])) .'</span>';
	$comodocDisplay .='</div>';
	
	// Article Column
	$comodocDisplay .='<div class="col-12 col-xs-12 col-sm-8 col-md-9 col-lg-9 col-xl-10"><p>';
...
$comodocDisplay .= '<li class="publication row"><div class="col-12 col-xs-12 col-sm-4 col-md-3 col-lg-3 col-xl-2"></div><div class="col-12 col-xs-12 col-sm-8 col-md-9 col-lg-9 col-xl-10"><em>'. insertStringText('Note: This is a select list of our scientific publications.','publications') .'</em></div></li>';
